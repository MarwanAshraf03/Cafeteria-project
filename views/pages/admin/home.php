        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="text-muted small">#<?php echo $latestOrder['id']; ?> · <?php echo $latestOrder['created_at']; ?></div>
                ...
                <div class="row g-3">
                    <?php foreach ($products as $product): ?>
                        <div class="col-md-6 col-xl-4">
                            <div class="product-card card h-100 border-0 shadow-sm" data-product-id="<?php echo $product['id']; ?>" data-price="<?php echo $product['price']; ?>">
                                <button type="button" class="product-image-btn" data-action="add">
                                    <img src="<?php echo htmlspecialchars($product['image_url']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
                                </button>
                                <div class="card-body">
                                    <h6 class="mb-1"><?php echo htmlspecialchars($product['name']); ?></h6>
                                    <div class="text-muted small mb-3">$<?php echo number_format($product['price'], 2); ?></div>
                                    <div class="d-flex align-items-center gap-2">
                                        <button type="button" class="btn btn-light btn-sm" data-action="decrease">-</button>
                                        <input class="form-control form-control-sm text-center quantity-input" type="number" min="0" name="items[<?php echo $product['id']; ?>]" value="0">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="notes" rows="4" placeholder="Any special instructions..."></textarea>
                        </div>
