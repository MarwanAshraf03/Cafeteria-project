        ...
        <table class="table align-middle m-0" style="border-collapse: separate; border-spacing: 0;">
          ...
          <tbody>
            <?php if (empty($ordersWithItems)): ?>
              <tr><td colspan="5" class="text-center text-muted p-4">No pending orders.</td></tr>
            <?php else: ?>
                        ...
                        <div class="text-center" style="width: 80px;">
                          <div class="position-relative d-inline-block">
                             <?php if (!empty($item['image_url'])): ?>
                               ...
                               <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" style="width: 60px; height: 60px; object-fit: cover;" class="rounded-circle mb-2 border">
                             <?php else: ?>
                               <div class="bg-secondary text-white rounded-circle d-flex align-items-center justify-content-center mb-2 mx-auto" style="width: 60px; height: 60px; font-size: 24px;">
                          ...
                          <div class="fw-bold small text-truncate" title="<?php echo htmlspecialchars($item['product_name']); ?>"><?php echo htmlspecialchars($item['product_name']); ?></div>
            ...
            <tbody>
              <?php foreach ($canceledOrdersWithItems as $order): ?>
                ...
                <tr>
                  ...
                  <td class="p-3"><?php echo htmlspecialchars($order['room_name']); ?></td>
                  <td class="p-3"><?php echo htmlspecialchars($order['extension']); ?></td>
                  <td class="p-3"><span class="badge bg-<?php echo $statusClass; ?>"><?php echo htmlspecialchars($statusLabel); ?></span></td>
                </tr>
                <tr>
                  <td colspan="5" class="p-0 border-bottom">
                    <div class="d-flex flex-wrap gap-4 p-4 table-light">
